          ...
          <Col lg={2}>
            ...
            <ul className="sl-list-1">
              <li className="sl-li">
                <a href="/events">
                  Events
                  <br /><a href="/ContentViews">Public Consulatation</a> 
                </a>
              </li>
              {/* <li className="sl-li">
                <a href="">
          ...
          <Col lg={3}>
            <div className="tablet:grid-col-4">
              <div className="">
                ...
                <form className="sl-form" action="" method="get">
                ...
                <span id="footer-phone">
                 {/* Footer part 2 Style*/}
                  <div className="contact-style">
                    <h5 className="">
                      <b style={{marginLeft:"0"}}>Sri Lanka Government Feedback Unit Contact Center</b>
                    </h5>
                  </div>
          ...
          >
            <div className="footer-content">
              <div className="sl-identifier__slgov-description" style={{marginTop:"0",paddingTop:"20px"}}>
                ...
                services. */}
                Sri Lanka Government Feedback Unit | 2023
              </div>
